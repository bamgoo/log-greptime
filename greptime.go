...
func newLogSchema() []*gpb.ColumnSchema {
	return []*gpb.ColumnSchema{
		...
		{ColumnName: "module", SemanticType: gpb.SemanticType_TAG, Datatype: gpb.ColumnDataType_STRING},
		...
		{ColumnName: "request_id", SemanticType: gpb.SemanticType_FIELD, Datatype: gpb.ColumnDataType_STRING},
		{ColumnName: "trace_id", SemanticType: gpb.SemanticType_FIELD, Datatype: gpb.ColumnDataType_STRING},
